...
const AntigravityInner: React.FC<AntigravityProps> = ({
  ...
  useFrame((state) => {
    ...
    particles.forEach((particle, i) => {
      ...
      const pulseFactor = 0.8 + pulse * 0.2

      const sizeVariance = 1 + (randomRadiusOffset * particleVariance) / 2
      const finalScale = particleSize * scaleFactor * pulseFactor * sizeVariance
